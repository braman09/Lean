...
namespace QuantConnect.Scheduling
{
    ...
    public class TimeRules
    {
        ...
        /// </summary>
        public ITimeRule Now => new FuncTimeRule("RunOnceNow", dates => dates.Select(date => date.Add(_securities.UtcTime.TimeOfDay)));

        /// <summary>
        /// Convenience property for running a scheduled event at midnight in the algorithm time zone
        /// </summary>
        public ITimeRule Midnight => At(TimeSpan.Zero);

        /// <summary>
        /// Convenience property for running a scheduled event at noon in the algorithm time zone
        /// </summary>
        public ITimeRule Noon => At(TimeSpan.FromHours(12));
